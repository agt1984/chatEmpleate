...
const config = {
  ...
  initialMessages: [
    createChatBotMessage(
      `Hola, bienvenid@ Empléate con Talento. Soy tu orientador virtual y puedo ayudarte a encontrar los mejores contenidos en función de tus necesidades, solo tienes que escojer las siguientes opciones.`,
      {
        widget: "BotonInicio",
      }
    ),
